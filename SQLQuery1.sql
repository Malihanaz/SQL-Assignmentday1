...
on primary (name='Products_Db',Filename='D:\Simplilearn phase2\Day1\Assignment\Products_Db.mdf',
size=24MB,MaxSize=48MB,filegrowth=8MB)
log on (name='Products_Db_log',filename='D:\Simplilearn phase2\Day1\Assignment\Products_Db_log.ldf')
